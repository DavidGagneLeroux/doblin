...
`Rscript ./main.R -t [MIN_FREQ] -o [OUTPUT_DIR] -n [INPUT_FILE_NAME] -i [INPUT_FILE] -c [TIME_CUTOFF]`

**Before running the following command line**, make sure to set your working directory to the `doblin/` folder. Here's an example of how to use the command line:
...
\item[-i:] Input file.
\item[-c:] Time point threshold. We cluster the lineages that persist for at least '-c' time points.
\end{description}
```
...
3. If Pearson correlation is selected, specify a method for computing covariances in the presence of missing values, as outlined in the `stats::cor()` documentation.
...
\begin{figure}[ht]
        \begin{subfigure}{0.5\textwidth}
          \includegraphics[width=0.9\linewidth]{images/test_cluster1_log10.pdf}
          \caption{Composition of cluster 1}
        \end{subfigure}
        \begin{subfigure}{0.5\textwidth}                                          
          \includegraphics[width=0.9\linewidth]{images/test_cluster2_log10.pdf}
          \caption{Composition of cluster 2}
        \end{subfigure}
        \begin{subfigure}{0.5\textwidth}
          \includegraphics[width=0.9\linewidth]{images/test_cluster3_log10.pdf}
          \caption{Composition of cluster 3}
        \end{subfigure}
        \begin{subfigure}{0.5\textwidth}     
          \includegraphics[width=0.9\linewidth]{images/test_cluster4_log10.pdf}
          \caption{Composition of cluster 4}
        \end{subfigure}
        \begin{subfigure}{0.5\textwidth}
          \includegraphics[width=0.9\linewidth]{images/test_cluster5_log10.pdf}
          \caption{Composition of cluster 5}
        \end{subfigure}
        \begin{subfigure}{0.5\textwidth}     
          \includegraphics[width=0.9\linewidth]{images/test_cluster6_log10.pdf}
          \caption{Composition of cluster 6}
        \end{subfigure}
        \begin{subfigure}{0.5\textwidth}     
          \includegraphics[width=0.9\linewidth]{images/test_loess_clusters_log10.pdf}
