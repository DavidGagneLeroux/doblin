...
plotJaccardIndex <- function(topFinal, topMax, library_topN, names){
  ...
  ggsave(plot.final,filename = paste(output_directory,"jaccard_final.eps", sep=""),width = 9,height = 8)
  ...
  ggsave(plot.max,filename =  paste(output_directory,"jaccard_max.eps", sep=""),width = 9,height = 8)
